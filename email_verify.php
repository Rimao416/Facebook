    ...
    if(isset($_GET['code'])){
        ...
        if(isset($_POST['submit'])){
            if(empty($_POST["user_otp"]))
            {
                ...
                if($total_row>0){
                    $query="
                        UPDATE register_user SET user_email_status='verified' WHERE user_activation_code='".$user_activation_code."'
                    ";
                    $statement=$connect->prepare($query);
...
<body>
    <br>
    <div class="container">
        <h3 align="center">PHP Registration with Email</h3>
        <br>
        <div class="panel panel-default">
            <div class="panel-heading">
                <h3 class="panel-title">Entrez OTP Number</h3>
            </div>
